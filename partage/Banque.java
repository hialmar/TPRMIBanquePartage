...
import exceptions.NotificationPresente;
...
public interface Banque extends Remote {
	...
	/**
	 * Demande à être notifié en cas de découvert
	 * @param id : identifiant du compte
	 * @param notification : objet serveur RMI sur lequel il faudra notifier
	 * @throws RemoteException : s'il y a un problème avec RMI
	 * @throws CompteInexistant : s'il n'y a pas de compte avec cet identifiant
	 * @throws NotificationPresente : s'il y a déjà un abonnement sur ce compte
	 */
	public void ajouterNotification(String id, Notification notification) throws RemoteException, CompteInexistant, NotificationPresente;
}
